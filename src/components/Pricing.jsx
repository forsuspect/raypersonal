            ...
            <motion.div
              ...
              className={`relative p-6 rounded-[2rem] border flex flex-col shrink-0 w-[85vw] sm:w-[300px] md:w-auto snap-center ${
                plan.highlight
                  ...
                  : 'border-wine-50 bg-white/80 hover:border-wine-200 transition-all shadow-sm'
              }`}
            >
              {plan.highlight && (
              ...
              <div className="space-y-2 mb-5 flex-1">
                {plan.features.map(feature => (
                  <div key={feature} className="flex items-center gap-2 text-left">
                    <div className="w-4 h-4 rounded-full bg-bordeaux/10 flex items-center justify-center shrink-0">
                      <FiCheck className="text-bordeaux text-[10px]" />
                    </div>
              ...
              <button className={`w-full py-3 rounded-xl font-bold text-xs uppercase tracking-widest flex items-center justify-center gap-2 transition-all ${
                plan.highlight ? 'btn-premium text-white' : 'border border-wine-100 text-wine-900/60 hover:border-wine-900 hover:bg-wine-50/20'
              }`}>
