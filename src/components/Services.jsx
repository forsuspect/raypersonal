...
const objectives = [
  ...
  { title: 'Definição', image: 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?q=80&w=800&auto=format&fit=crop' },
...
const Services = () => {
  ...
  return (
    <section id="objetivos" className="relative bg-premium-light overflow-hidden flex flex-col justify-center py-20" style={{ minHeight: '100dvh' }}>
      <div ref={ref} className="w-full max-w-7xl mx-auto px-6 flex flex-col justify-center gap-10">
          ...
          {objectives.map((obj, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 p-4 md:p-5 flex flex-col justify-end text-white">
                <h3 className="text-sm md:text-base font-black leading-tight drop-shadow-lg">{obj.title}</h3>
